...
const productReducer = createReducer(initialState, {
  ...
  //SEARCH_LIST
  [REQUEST(PRODUCT_ACTION.GET_SEARCH_LIST)]: (state, action) => {
    return {
      ...state,
      productListSearch: {
  ...
  [FAIL(PRODUCT_ACTION.GET_SEARCH_LIST)]: (state, action) => {
    const { error } = action.payload;
    return {
      ...state,
      productListSearch: {
  ...
  //CLEAR_SEARCH
  [SUCCESS(PRODUCT_ACTION.CLEAR_SEARCH_LIST)]: (state, action) => {
    return {
      ...state,
      productListSearch: [],
    };
